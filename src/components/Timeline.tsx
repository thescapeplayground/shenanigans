  ...
  return (
    <div className="rounded-lg border">
      <div className="relative px-4">
        ...
        <div className="relative pt-8">
          <div className="grid grid-cols-3 gap-4">
            ...
            <div className="text-[11px] text-center">
              ...
              <p className="text-[10px] text-muted-foreground mt-1">College Undergraduate</p>
            </div>
          </div>
        </div>
        ...
        {/* Years */}
        <div className="grid grid-cols-3 gap-4 mt-2 pb-4">
          <div className="text-[10px] text-muted-foreground text-center">2018 - 2021</div>
          <div className="text-[10px] text-muted-foreground text-center">2021 - 2023</div>
          <div className="text-[10px] text-muted-foreground text-center">2023 - 2024</div>
        </div>
      </div>
    </div>
  );
